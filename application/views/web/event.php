                        <div class="col col_12_of_12">
                            ...
                            <div class="row">
                                <div class="col col_12_of_12">
                                    <?php foreach ($event as $art): ?>
                                    <!-- Layout post 1 -->
                                    <div class="layout_post_2 clearfix">
                                        <div class="item_thumb">
                                            <div class="thumb_icon">
                                                <a href="<?php echo site_url('web/event_read/'.$art->id."/".str_replace(array(' ',',',':','--'), '-', $art->nama)) ?>" jQuery><i class="fa fa-copy"></i></a>
                                            </div>
                                            <div class="thumb_hover">
                                                <a href="<?php echo site_url('web/event_read/'.$art->id."/".str_replace(array(' ',',',':','--'), '-', $art->nama)) ?>"><img src="<?php echo base_url('img/event/'.$art->img) ?>" alt="Post"></a>
                                            </div>
                                            <div class="thumb_meta">
                                                <span class="category" jQuery><a href="<?php echo site_url('web/event_read/'.$art->id.'/'.str_replace(array(' ',',',':','--'), '-', $art->nama)) ?>">Read more</a></span>
                                            </div>
                                        </div>
                                        <div class="item_content">
                                            <h4><a href="<?php echo site_url('web/view_read/'.$art->id.'/'.str_replace(array(' ',',',':','--'), '-', $art->nama)) ?>"><?php echo $art->nama ?></a></h4>
                                            <p><?php echo substr($art->intro, 0, 250) ?> [...]</p>
                                            <div class="item_meta clearfix">
                                            <span class="meta_date"><?php echo $this->idn_times->hari_indo($art->date).", ".$this->idn_times->tgl_db($art->date) ?></span>
                                        </div>
                                        </div>
