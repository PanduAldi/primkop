                        <div class="col col_12_of_12">
                            <!-- Page title -->
                            <h1 class="page_title">Gallery </h1><!-- End Page title -->
                            <!-- Row -->
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-xs-12">
                                    ...
                                    <div class="layout_post_1">
                                        <div class="item_content">
                                            <h4><a href="<?php echo site_url('web/view_gallery/'.$gal->id_gallery.'/'.str_replace(" ","-", $gal->nama)) ?>"><?php echo ucwords($gal->nama) ?></a></h4>
                                        </div>
                                        <div class="panel panel-danger">
                                            <div class="panel body">
                                                <div class="item_thumb">
                                                    <div class="thumb_icon">
                                                        <a href="<?php echo site_url('web/view_gallery/'.$gal->id_gallery.'/'.str_replace(" ","-", $gal->nama)) ?>" jQuery><i class="fa fa-copy"></i></a>
                                                    </div>
                                                    <div class="thumb_hover">
                                                        <a href="<?php echo site_url('web/view_gallery/'.$gal->id_gallery.'/'.str_replace(" ","-", $gal->nama)) ?>"><img src="<?php echo base_url('img/thumb/'.$gal->thumb) ?>" alt="Post"></a>
                                                    </div>
                                                    <div class="thumb_meta">
                                                        <span class="category" jQuery><a href="<?php echo site_url('web/view_gallery/'.$gal->id_gallery.'/'.str_replace(" ","-", $gal->nama)) ?>">Lihat Gallery</a></span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
