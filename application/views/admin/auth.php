...
<html lang="en">
	<head>
		...
		<!-- ace styles -->
		<link rel="stylesheet" href="<?php echo base_url() ?>assets/webadmin/ace_admin/css/ace.min.css" />

		<!--[if lte IE 9]>
			<link rel="stylesheet" href="<?php echo base_url() ?>assets/webadmin/ace_admin/css/ace-part2.min.css" />
		<![endif]-->
		<link rel="stylesheet" href="<?php echo base_url() ?>assets/webadmin/ace_admin/css/ace-rtl.min.css" />
											...
											<form action="" method="POST">
												<fieldset>
													...
													<div class="clearfix">
														...
														<button id="load" class="width-35 pull-right btn btn-sm btn-primary">
...
<![endif]-->
		...
		<script type="text/javascript">
			...
			$(function(){
				...
				$('#alert-delay').delay(3000).fadeOut(500);
			})
