...
<div class="row">
	...
	<form action="" method="POST" enctype="multipart/form-data">
		<div class="col-lg-9">
			...
			<input type="text" name="nama" class="form-control" value="<?php echo $profil['nama'] ?>" autofocus>
			<br>
			<label for="" class="control-label">Isi : </label>
			<textarea name="isi" rows="20"><?php echo $profil['isi'] ?></textarea>
		</div>
		<div class="col-lg-3">
				...
				<div class="panel-body">
					<?php  
						...
						for($i=0; $i < count($status); $i++) {
							$checked = ($profil['publish']==$status[$i])?"checked":"";
