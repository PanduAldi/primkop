...
<div>
  ...
  <ul class="nav nav-tabs" role="tablist">
    <li role="presentation" class="active"><a href="#home" aria-controls="home" role="tab" data-toggle="tab">Update Produk</a></li>
		...
		<div class="row">	
			...
			<form action="" method="POST" enctype="multipart/form-data">
				<div class="col-lg-9">
					...
					<input type="text" name="nama" class="form-control" value="<?php echo $produk['nama'] ?>" autofocus>					
					<br>
					<label for="" class="control-label">Intro :</label>
					<input type="text" name="intro" class="form-control" value="<?php echo $produk['intro'] ?>">
					<br>
					<label for="" class="control-label">Deskripsi Produk : </label>
					<textarea name="deskripsi" rows="20"><?php echo $produk['deskripsi'] ?></textarea>
				</div>
				<div class="col-lg-3">
					<div class="upload">
						<label for="" class="control-label">Image Produk : </label>
						<input type="file" name="img" class="form-control" />
						<img src="<?php echo base_url('img/produk/'.$produk['img']) ?>" height="200" width="200" alt="">
					</div><br>
