...
class Member extends CI_Controller {
	...
	{
		parent::__construct();
		$this->load->library(array(array('form_validation', 'email','fpdf')));
	...
	public function cetakpdf()
	{
		...
		$data['title'] = "Cetak Formulir Pendaftaran";

		$data['ambil_data'] = $this->safina_model->cetak($id)->row();
		//show web
		$this->load->view('web/member/cetak_pdf', $data);
	}
